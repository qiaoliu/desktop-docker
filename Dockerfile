...
FROM ubuntu:12.10
MAINTAINER Lairdnote "lairdnote@gmail.com"
...
RUN apt-get install -y xpra rox-filer ssh pwgen xserver-xephyr xdm fluxbox libssl-dev wget gcc make git 
...
RUN apt-get install -y firefox xterm ubuntu-restricted-extras 
